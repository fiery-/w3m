...
w3m_auxbin_dir()
{
    return w3m_dir("W3M_AUXBIN_DIR", "/opt/local/libexec/w3m");//AUXBIN_DIR);
}
...
w3m_lib_dir()
{
    ...
    return w3m_dir("W3M_LIB_DIR", "/opt/local/libexec/w3m/cgi-bin");//CGIBIN_DIR);
}

char *
w3m_etc_dir()
{
    return w3m_dir("W3M_ETC_DIR", "/opt/local/etc");//ETC_DIR);
}

char *
w3m_conf_dir()
{
    return w3m_dir("W3M_CONF_DIR", "/opt/local/etc/w3m");//CONF_DIR);
}

char *
w3m_help_dir()
{
    return w3m_dir("W3M_HELP_DIR", "/opt/local/share/w3m");//HELP_DIR);
}
/* Local Variables:    */
/* c-basic-offset: 4   */
/* tab-width: 8        */
