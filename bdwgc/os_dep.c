...
#include "include/private/gc_priv.h" //Ogi - include/
...
//Ogi - functions differ in mach/exc.h 
//extern kern_return_t
                                          ...
                                          mach_msg_type_number_t data_count)
{
  ...
  switch(behavior) {
    case EXCEPTION_STATE:
      r = exception_raise_state(port, 
//                                thread, task, //Ogi - function differ
                                exception, data, data_count,
